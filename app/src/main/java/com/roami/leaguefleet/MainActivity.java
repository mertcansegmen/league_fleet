...
public class MainActivity extends AppCompatActivity {
    ...
    //Variables that will hold information about questions
    int atQuestion;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        questions = new Question[Variables.NUMBER_OF_QUESTIONS];

        //Setting the questions that will be shown to user
        for(int i = 0; i< Variables.NUMBER_OF_QUESTIONS; i++)
    ...
    private void buttonClicked(char userSelection, Button button) {
        ...
        progressBar.incrementProgressBy(Variables.PROGRESS_BAR_INCREMENT);
        counter.cancel();
        ...
        if(userSelection == questions[atQuestion].getAnswer()){
            ...
            }, Variables.BUTTON_COLOR_CHANGING_TIME);
    ...
    private void updateQuestion(){
        ...
        //If the quiz is completed app goes to finish activity and quiz information gets passed to there
        if(atQuestion >= Variables.NUMBER_OF_QUESTIONS){
            //atQuestion = 0;
        ...
        circularProgressBar.setProgress(Variables.PROGRESS_BAR_MAX);
        ...
        counter = new CountDownTimer(30000, 1000) {
            ...
            public void onTick(long millisUntilFinished) {
                ...
                circularProgressBar.incrementProgressBy(Variables.CIRCULAR_PROGRESS_BAR_INCREMENT);
            }
    ...
    private int[] findRandomIndexes(){
        ...
        int[] array = new int[Variables.NUMBER_OF_QUESTIONS];
